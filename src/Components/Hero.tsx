...
export default function Hero() {
  return (
    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8   mt-8">
      <div className="bg-[#53389E] text-center flex justify-center items-center flex-col rounded-3xl px-24 py-8 pb-40" >
        <div className="gap-6 mb-5">
          <h1
            className="text-white text-7xl font-semibold leading-12"
          ...
          <p className="text-[#E9D7FE] text-xl ">
        ...
        <div>
          <div className="flex flex-col">
            ...
            <p className="text-[#E9D7FE] text-sm text-left">
